...
@Component({ selector:'app-admin-dashboard-page', standalone:true, imports:[DatePipe,RouterLink,DashboardPeriodControlsComponent,DashboardRankComponent,DashboardSeriesComponent,MetricCardComponent], providers:[AdminDashboardFacade], templateUrl:'./admin-dashboard-page.component.html', styleUrl:'../../../../shared/dashboard/dashboard-page.scss', styles:['.distribution li{display:block;padding:0}.distribution li a{display:flex;justify-content:space-between;padding:.5rem 0;color:var(--color-text);text-decoration:none}.distribution li a:hover,.distribution li a:focus-visible{color:var(--color-primary);text-decoration:underline}'], changeDetection:ChangeDetectionStrategy.OnPush })
