...
export interface BookWriteRequest {
  ...
  language: string; pageCount: number | null; genres?: string[]; categoryIds?: string[]; tags: string[];
...
export interface StaffBookQuery {
  categoryId?: string; query: string; bookId: string; genre: string; mediaType: string; language: string; available: string;
...
export const DEFAULT_STAFF_BOOK_QUERY: StaffBookQuery = {
  categoryId: '', query: '', bookId: '', genre: '', mediaType: '', language: '', available: '', isActive: '', lowStock: '',
