...
@Component({ selector: 'app-staff-shell', standalone: true, imports: [WorkspaceShellComponent], template: `<app-workspace-shell [navigation]="navigation" [navigationGroups]="navigationGroups" [username]="username" [contextLabel]="contextLabel" (logoutRequested)="logout()" />`, changeDetection: ChangeDetectionStrategy.OnPush })
